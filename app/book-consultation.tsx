...
const BookConsultation = () => {
  ...
  const renderFormField = (label, value, placeholder, onChange, iconName, isPicker = false, onPress = null) => (
    <View style={styles.inputGroup}>
      <Text style={styles.label}>{label}</Text>
      <View style={styles.inputContainer}>
        <Ionicons name={iconName} size={20} color="#6c757d" style={styles.inputIcon} />
        {isPicker ? (
    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.formContainer}>
          ...
          {renderFormField("Full Name", patientName, "Enter patient's full name", setPatientName, "person")}
          ...
          {renderFormField("Contact Number", phone, "Enter phone number", setPhone, "call")}
          {renderFormField("Address", address, "Enter full address", setAddress, "location")}
          ...
          <TouchableOpacity style={styles.bookButton} onPress={handleBookAppointment}>
            ...
            <Ionicons name="checkmark-circle" size={24} color="#fff" style={styles.bookIcon} />
          </TouchableOpacity>
        </View>
            ...
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalScroll}>
                {procedures.map((item) => (
                  ...
                  >
                    <Ionicons 
                      name={procedure === item ? "radio-button-on" : "radio-button-off"} 
                      size={20} 
